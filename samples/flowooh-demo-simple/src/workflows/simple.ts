...
export default class SimpleWorkflow extends Workflow {
  ...
  public task02(
    @Param('activity') activity: EventActivity,
    @Data() data: any,
    @Ctx() context: Context,
  ) {
    context.data = {
      ...(data || {}),
      trace: [...(data?.trace || []), 'task02'],
    };
    activity.takeOutgoing();
  }
